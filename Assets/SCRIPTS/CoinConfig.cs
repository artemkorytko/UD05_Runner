...
//------------------ конфиг одного типа монетки, висит на префабе ---------------------- 
//-------- первый эксперементальный конфиг (урок 21, 2:11) -----------------------------
namespace Runner
{
    ...
    // встроенный класс-контейнер для работы с информацией, поддерживает сценарии
